...
export AIRFLOW__DATABASE__SQL_ALCHEMY_CONN="sqlite:///$PROJECT_DIR/airflow_home/airflow.db"
...
nohup airflow webserver --port 8080 > "$PROJECT_DIR/logs/webserver_sqlite.log" 2>&1 &
WEBSERVER_PID=$!
